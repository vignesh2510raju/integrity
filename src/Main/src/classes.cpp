...
Parameters::Parameters()
{
	...
	min_cluster_distance= 0.3; // when clustering, this is the minimum distance in between two clusters. If the distance is less than this, they won't be divide into two clusters
	...
	plane_RANSAC_max_iter= 1000; // Max # of iterations for the plane extraction. RANSAC parameter.
